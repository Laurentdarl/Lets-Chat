...
class ChatsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Users").child(navArgs.chats.userId.toString())
        displayProfilePic()
    ...
    private fun displayProfilePic() {
        databaseReference.addValueEventListener(object: ValueEventListener
        {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(requireContext(), "Could not load profile Image", Toast.LENGTH_SHORT).show()
            }
        })
    }
